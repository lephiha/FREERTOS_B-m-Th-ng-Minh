...
const char* serverTime = "http://192.168.1.206//esp-time-duration.php"; // Replace with your server URL
const char* serverUrl = "http://192.168.1.206//esp-post-data.php?api_key=";
const char* serverPumpStatusUrl = "http://192.168.1.206//esp-get-pump-status.php"; // Replace with your server URL
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    DEBUG_PRINTLN("Received JSON: " + jsonData);
  ...
  Serial.print(String(statusRelay));
